...
import com.codespeedy.projectMP.Fragment.Albums;
import com.codespeedy.projectMP.Fragment.Artist;
import com.codespeedy.projectMP.Fragment.PlayLists;
import com.codespeedy.projectMP.Fragment.Songs;
import com.codespeedy.projectMP.Model.AudioListModel;
import com.codespeedy.projectMP.Model.SavePlayListSong;
import com.codespeedy.projectMP.Permission.PermissionListener;
...
//        navHeader.setBackgroundColor(MainActivity.activity.getResources().getColor(R.color.toolbar_color));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        else if(item.getItemId() == R.id.exit_id)
        {
            onBackPressed();
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if(id == R.id.nav_theme)
        {
            ...
            startActivity(new Intent(MainActivity.activity, FeedbackActivity.class));
