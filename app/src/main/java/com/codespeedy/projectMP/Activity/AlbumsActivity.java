...
public class AlbumsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(AlbumArrayList.get(k).get(0).getAlbum());
        ...
        Picasso.with(this)
                .load(AlbumArrayList.get(k).get(0).getAlbumArtUri())
                .fit()
        ...
        songCount.setText(AlbumArrayList.get(k).size()+" Songs");
    ...
    public void setBottomPlayer()
    {
        ...
        SharedPreferences themePref = PreferenceManager.getDefaultSharedPreferences(com.codespeedy.projectMP.Activity.MainActivity.activity);
        String theme = themePref.getString("theme",null);
        if(theme!=null && theme.equals("dark"))
        {
            coordinatorLayout.setBackgroundColor(com.codespeedy.projectMP.Activity.MainActivity.activity.getResources().getColor(R.color.toolbar_color));
            songName.setTextColor(com.codespeedy.projectMP.Activity.MainActivity.activity.getResources().getColor(R.color.colorLight));
            progressBar.setProgressTintList(ContextCompat.getColorStateList(com.codespeedy.projectMP.Activity.MainActivity.activity,R.color.colorLight));
    ...
    public void onSongSelected(int i)
    {
        ...
        PresentArrayList = MainActivity.AlbumArrayList.get(k);
        position = i;
        if(mediaPlayer!=null)
        {
            mediaPlayer.stop();
